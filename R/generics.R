...
setGeneric(
  name = "stass_fit",
  def = function(object, ...) standardGeneric("stass_fit")
)
...
setGeneric(
  name = "stass_predict",
  def = function(x, new_data, ...) standardGeneric("stass_predict")
)
...
setGeneric(
  name = "stass_simulate",
  def = function(object, ...) standardGeneric("stass_simulate")
)
...
setGeneric(
  name = "stass_update",
  def = function(x, y) standardGeneric("stass_update")
)
