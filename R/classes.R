#' A list of classes in the stass package.
#'
#' To see documentation for a particular class, load the package and run e.g.
#'   class?stass. To see a list of all methods available for a specific class,
#'   see the help page for that class or run e.g.
#'   \code{methods(class="stass")}.
#'
#' @section Classes:
#' \itemize{
#'   \item dag
...
#' An S4 class to hold process parameters for a stass model.
#'
#' @slot covariance_function The covariance function, must be one from
#'   get_stass_distributions("covariance").
#' @slot space_parameters A list containing spatial parameters for each spatio-temporally varying growth parameter.
#'   variable.
#' @slot time_parameters A list containing time parameters for each spatio-temporally varying growth parameter.
#'   variable.
#'
#' @family stass_classes
#'
...
#' An S4 class to hold the process information for a stass model.
#'
...
#' An S4 class to hold observation parameters for a stass model.
#'
...
#'   for each spatio-temporally varying parameter.
#'
#' @family stass_classes
#'
...
#' An S4 class to hold the observation information for a stass model.
#'
...
#' An S4 class to hold optimization tracing for a stass model
#'
...
#' An S4 class describing a stass model.
#'
...
#'
#' @seealso process_parameters_class, observation_parameters_class, stass_class
#'
