...
#' A list of accessor functions for the stass package
#'
#' These accessor functions are used to extract different components from the
#'   objects used in the stass package. This help page is meant only to catalogue
...
#'   The main classes implemented in the stass package are \linkS4class{dag},
#'   \linkS4class{long_stars}, \linkS4class{tracing}, and \linkS4class{stass}.
#'
#' @param x An object
#' @param value A replacement value
#'
#' @seealso \linkS4class{dag}, \linkS4class{long_stars}, \linkS4class{tracing}, \linkS4class{stass}
#'
#' @name stass_access
#'
#' @keywords internal
...
#' @describeIn stass_access Get convergence message
#' @export
setGeneric(
  name = "convergence",
...
#' @describeIn stass_access Get covariance function
#' @export
setGeneric(
...
#' @describeIn stass_access Set covariance function
#' @export
setGeneric(
  name = "covariance_function<-",
...
#' @describeIn stass_access Get data
#' @export
setGeneric(
  name = "dat",
...
#' @describeIn stass_access Set data
#' @export
setGeneric(
  name = "dat<-",
...
#' @describeIn stass_access Get data predictions
#' @export
setGeneric(
...
#' @describeIn stass_access Get distance units
#' @export
setGeneric(
  name = "distance_units",
...
#' @describeIn stass_access Set distance units
#' @export
setGeneric(
  name = "distance_units<-",
...
#' @describeIn stass_access Get distances
#' @export
setGeneric(
  name = "distances",
...
# #' @describeIn stass_access Set distances
#' @noRd
setGeneric(
  name = "distances<-",
...
#' @describeIn stass_access Get edges
#' @export
setGeneric(
  name = "edges",
...
# #' @describeIn stass_access Set edges
#' @noRd
setGeneric(
  name = "edges<-",
...
#' @describeIn stass_access Get fixed effects
#' @export
setGeneric(
  name = "fixed_effects",
...
#' @describeIn stass_access Set fixed effects
#' @export
setGeneric(
  name = "fixed_effects<-",
...
#' @describeIn stass_access Get model formula
#' @export
setGeneric(
  name = "formula",
...
#' @describeIn stass_access Set model formula
#' @export
setGeneric(
  name = "formula<-",
...
#' @describeIn stass_access Get graph
#' @export
setGeneric(
  name = "graph",
...
#' @describeIn stass_access Get hessian computation time
#' @export
setGeneric(
  name = "hess_time",
...
# #' @describeIn stass_access Set hessian computation time
#' @noRd
setGeneric(
  name = "hess_time<-",
...
#' @describeIn stass_access Get locations
#' @export
setGeneric(
  name = "locations",
...
#' @describeIn stass_access Get n_neighbours setting
#' @export
setGeneric(
  name = "n_neighbours",
...
# #' @describeIn stass_access Set n_neighbours setting
#' @noRd
setGeneric(
  name = "n_neighbours<-",
...
# #' @describeIn stass_access Get TMB::MakeADFun object
#' @noRd
setGeneric(
  name = "obj",
...
# #' @describeIn stass_access Set TMB::MakeADFun object
#' @noRd
setGeneric(
  name = "obj<-",
...
# #' @describeIn stass_access Get observations
#' @noRd
setGeneric(
  name = "observations",
...
# #' @describeIn stass_access Set observations
#' @noRd
setGeneric(
  name = "observations<-",
...
# #' @describeIn stass_access Get optimizer object
#' @noRd
setGeneric(
  name = "opt",
...
# #' @describeIn stass_access Set optimizer object
#' @noRd
setGeneric(
  name = "opt<-",
...
#' @describeIn stass_access Get optimization time
#' @export
setGeneric(
  name = "opt_time",
...
# #' @describeIn stass_access Set optimization time
#' @noRd
setGeneric(
  name = "opt_time<-",
...
#' @describeIn stass_access Get parameter estimator covariance matrix
#' @export
setGeneric(
...
# #' @describeIn stass_access Set parameter estimator covariance matrix
#' @noRd
setGeneric(
  name = "parameter_covariance<-",
...
#' @describeIn stass_access Get parameter estimator hessian matrix
#' @export
setGeneric(
...
# #' @describeIn stass_access Set parameter estimator hessian matrix
#' @noRd
setGeneric(
  name = "parameter_hessian<-",
...
#' @describeIn stass_access Get parameters
#' @export
setGeneric(
  name = "parameters",
...
#' @describeIn stass_access Set parameters
#' @export
setGeneric(
  name = "parameters<-",
...
#' @describeIn stass_access Get persistent graph
#' @export
setGeneric(
...
# #' @describeIn stass_access Set persistent graph
#' @noRd
setGeneric(
  name = "persistent_graph<-",
...
#' @describeIn stass_access Get persistent graph random effects
#' @export
setGeneric(
  name = "pg_re",
...
#' @describeIn stass_access Set persistent graph random effects
#' @export
setGeneric(
  name = "pg_re<-",
...
# #' @describeIn stass_access Get process
#' @noRd
setGeneric(
  name = "process",
...
# #' @describeIn stass_access Set process
#' @noRd
setGeneric(
  name = "process<-",
...
#' @describeIn stass_access Get random effects
#' @export
setGeneric(
  name = "random_effects",
...
#' @describeIn stass_access Get response distribution parameters
#' @export
setGeneric(
...
#' @describeIn stass_access Set response distribution parameters
#' @export
setGeneric(
  name = "response_parameters<-",
...
# #' @describeIn stass_access Get TMB::sdreport object
#' @noRd
setGeneric(
  name = "sdr",
...
# #' @describeIn stass_access Set TMB::sdreport object
#' @noRd
setGeneric(
  name = "sdr<-",
...
#' @describeIn stass_access Get standard error computation time
#' @export
setGeneric(
  name = "sdr_time",
...
# #' @describeIn stass_access Set standard error computation time
#' @noRd
setGeneric(
  name = "sdr_time<-",
...
#' @describeIn stass_access Get settings
#' @export
setGeneric(
  name = "settings",
...
# #' @describeIn stass_access Set settings
#' @noRd
setGeneric(
  name = "settings<-",
...
#' @describeIn stass_access Get spatial parameters
#' @export
setGeneric(
...
#' @describeIn stass_access Set spatial parameters
#' @export
setGeneric(
  name = "space_parameters<-",
...
#' @describeIn stass_access Get transient graph random effects
#' @export
setGeneric(
  name = "tg_re",
...
#' @describeIn stass_access Set transient graph random effects
#' @export
setGeneric(
  name = "tg_re<-",
...
#' @describeIn stass_access Get time effects
#' @export
setGeneric(
  name = "time_effects",
...
#' @describeIn stass_access Set time effects
#' @export
setGeneric(
  name = "time_effects<-",
...
# #' @describeIn stass_access Get time name used
#' @noRd
setGeneric(
  name = "time_name",
...
#' @describeIn stass_access Get time parameters
#' @export
setGeneric(
...
#' @describeIn stass_access Set time parameters
#' @export
setGeneric(
  name = "time_parameters<-",
...
#' @describeIn stass_access Get model computation times
#' @export
setGeneric(
  name = "timing",
...
# #' @describeIn stass_access Get TMB_out
#' @noRd
setGeneric(
  name = "TMB_out",
...
# #' @describeIn stass_access Set TMB_out
#' @noRd
setGeneric(
  name = "TMB_out<-",
...
#' @describeIn stass_access Get tracing information
#' @export
setGeneric(
  name = "tracing",
...
# #' @describeIn stass_access Set tracing information
#' @noRd
setGeneric(
  name = "tracing<-",
...
#' @describeIn stass_access Get transient graph
setGeneric(
  name = "transient_graph",
  def = function(x) standardGeneric("transient_graph")
)

# #' @describeIn stass_access Set transient graph
#' @noRd
setGeneric(
  name = "transient_graph<-",
...
#' @describeIn stass_access Get values
#' @export
setGeneric(
  name = "values",
...
#' @describeIn stass_access Set values
#' @export
setGeneric(
  name = "values<-",
